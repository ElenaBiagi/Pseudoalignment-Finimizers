...
inline uint16_t pseudoalignment_stats( vector<int64_t>& Fmin, const fulgor::CompressedColorSetsHybrid& CCS, const uint64_t n_colors, vector<pair<uint16_t, uint16_t>>& ans, const float t );

inline void pseudoalignment_stats( vector<int64_t>& Fmin, const fulgor::CompressedColorSetsHybrid& CCS, const uint64_t n_colors, vector<pair<uint16_t, uint16_t>>& ans);
...
public:
    fulgor::CompressedColorSetsHybrid CCS; // L, EF, BV
    ...
    CompressedColoredFinimizers(ColoredFinimizers&& cf, int64_t prefix_len, uint64_t kmer_size) {
        ...
        fulgor::CompressedColorSetsHybrid CCS(deduplicated_cs, n_colors, this->color_set_ids);
...
void read_colors(const fulgor::CompressedColorSetsHybrid& CCS, const uint64_t n_colors, vector<uint64_t>& results, const vector<pair<int64_t, uint64_t>>& fmin_v){
...
inline uint16_t pseudoalignment_stats(vector<int64_t>& Fmin, const fulgor::CompressedColorSetsHybrid& CCS, const uint64_t n_colors, vector<pair<uint16_t, uint16_t>>& ans,  const float t ){ //vector<uint64_t>& results,
