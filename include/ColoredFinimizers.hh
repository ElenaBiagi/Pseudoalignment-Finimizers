...
public:
    ...
    void search(const std::string& query, vector<uint64_t>& Finimizers, vector<int16_t>& results, vector<pair<uint16_t, int16_t>>& ans) const {
        ...
        // Color sets
        {
            ...
            pseudoalignment_stats(this->CCS, this->n_colors, Finimizers, results, ans);
            auto end = std::chrono::high_resolution_clock::now();
    ...
    uint16_t search(const std::string& query, vector<uint64_t>& Finimizers, vector<int16_t>& results, vector<pair<uint16_t, int16_t>>& ans, const float t) const {
        ...
        uint16_t min_value;
        {
            ...
            min_value = pseudoalignment_stats(this->CCS, this->n_colors, Finimizers, results, ans, t);
