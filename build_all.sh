...
/usr/bin/time makeblastdb -in /home/biagiele/${folder}/seq/${folder}_num_concat.fa -parse_seqids -blastdb_version 5 -out "${folder}/index/blastdb_${folder}" -dbtype nucl 1> $HOME/Pseudoalignment-Finimizers/results/blast_build_${folder}-k31.stdout 2> $HOME/Pseudoalignment-Finimizers/results/blast_build_${folder}-k31.stderr
source /module_load_cobs.sh 
echo "0.c. Build the index for COBS"
/usr/bin/time $HOME/cobs/build/src/cobs compact-construct --clobber /home/biagiele/${folder}/num/ ${folder}/index/cobs/cobs_${folder}.cobs_compact 1> $HOME/Pseudoalignment-Finimizers/results/cobs_build_${folder}-k31.stdout 2> $HOME/Pseudoalignment-Finimizers/results/cobs_build_${folder}-k31.stderr