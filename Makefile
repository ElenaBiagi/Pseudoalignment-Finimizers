.PHONY: finimap
finimap:
	$(CXX) src/main.cpp SBWT/build/libsbwt_static.a SBWT/build/external/sdsl-lite/build/lib/libsdsl.a -std=c++2a -I ./SBWT/sdsl-lite/include/ -O2 -I include -I ./SBWT/include -I ./SBWT/include/sbwt -I SBWT/build/external/sdsl-lite/build/external/libdivsufsort/include/ -g -fno-omit-frame-pointer -fno-inline-small-functions -o finimap -Wno-deprecated-declarations -march=native -DNDEBUG -fopenmp -lz -D MAX_KMER_LENGTH=250
