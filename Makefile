.PHONY: finimap
finimap:
	$(CXX) src/main.cpp src/color_set.cpp SBWT/build/libsbwt_static.a SBWT/build/external/sdsl-lite/build/lib/libsdsl.a -std=c++2a -I ./SBWT/sdsl-lite/include/ -O3 -I include -I ./SBWT/include -I ./SBWT/include/sbwt -I SBWT/build/external/sdsl-lite/build/external/libdivsufsort/include/ -g -o finimap -Wno-deprecated-declarations -march=native -DNDEBUG -fopenmp -lz -D MAX_KMER_LENGTH=250 -D _GLIBCXX_DEBUG -D _GLIBCXX_DEBUG_PEDANTIC -fsanitize=address
