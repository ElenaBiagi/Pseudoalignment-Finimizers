...
def main():
    ...
    for query_name in [query_n]:
        ...
        for r in range(R):
            ...
            list_minimap = [res for res in list_minimap if res[0] >= minimap_threshold * tm]
            ...
            M[3, start: end] [M[3, start: end] < (minimap_threshold * tm)] = 0
    ...
    labels = M[3, :] = (M[3, :]>0).astype(int) # Minimap2 
